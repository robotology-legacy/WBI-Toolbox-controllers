...
{
  extern unsigned int
    sf_balancingController_with_OOT_and_transfer_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WBCLibrary_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_balancingController_with_OOT_and_transfer_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int
    sf_balancingController_with_OOT_and_transfer_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "balancingController_with_OOT_and_transfer") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_balancingController_with_OOT_and_transfer_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_balancingController_with_OOT_and_transfer_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "balancingController_with_OOT_and_transfer") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_balancingController_with_OOT_and_transfer_third_party_uses_info
      (nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "balancingController_with_OOT_and_transfer") == 0) {
    ...
    newRhs[2] = prhs[3];
    return
      sf_balancingController_with_OOT_and_transfer_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_balancingController_with_OOT_and_transfer_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"balancingController_with_OOT_and_transfer")) {
    return(sf_balancingController_with_OOT_and_transfer_method_dispatcher
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    balancingController_with_OOT_and_transfer_terminator();
...
extern void balancingController_with_OOT_and_transfer_register_exported_symbols
  (SimStruct* S);
extern void WBCLibrary_register_exported_symbols(SimStruct* S);
extern void balancingController_with_OOT_and_transfer_debug_initialize(struct
...
{
  balancingController_with_OOT_and_transfer_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      balancingController_with_OOT_and_transfer_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    balancingController_with_OOT_and_transfer_initializer();
    if (!simModeIsRTWGen) {
