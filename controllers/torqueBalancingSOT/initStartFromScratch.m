...
run(strcat('app/robots/',getenv('YARP_ROBOT_NAME'),'/gainsFromScratch.m')); 

robotSpecificFSM = fullfile('app/robots',getenv('YARP_ROBOT_NAME'),'initStateMachineFromScratch.m');
