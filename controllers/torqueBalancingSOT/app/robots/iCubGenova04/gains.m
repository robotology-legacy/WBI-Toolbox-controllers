...
gain.CoM.posPD         = [50 * ones(11, 3), 0* 2 * sqrt(ones(11,3))];  %for 11 states, x-y-z directions

gain.root.rotPD        = ones(11,1) * [5,   0* 2 ];

gain.lFoot.posPD       = [25*ones(11,3),    0* 2*sqrt(ones(11,3))]; %for 11 states, x-y-z directions
gain.lFoot.rotPD       = ones(11,1) * [25,  0* 2 ];
