...
if strcmpi(SM.SM_TYPE, 'WALKING')
    ...
    gain.impedances  = [20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50;  % state ==  1  TWO FEET BALANCING
                        ...
                        20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    90     50  50, 30   50   30    90     50  50;  % state ==  6  TRANSITION TO INITIAL POSITION 
...
sm.com.states      = [0.01,  0.00,  0.00;   %% state ==  1  TWO FEET BALANCING NOT USED
                      0.01,  0.00,  0.00;   %% state ==  2  COM TRANSITION TO LEFT FOOT: THIS REFERENCE IS USED AS A DELTA W.R.T. THE POSITION OF THE LEFT FOOT
                      0.01,  0.00,  0.00;   %% state ==  3  LEFT FOOT BALANCING
                      0.01,  0.00,  0.00;   %% state ==  4  PREPARING FOR SWITCHING
                      0.01, -0.01, -0.01;   %% state ==  5  LOOKING FOR CONTACT
                      0.01,  0.00,  0.00;   %% state ==  6  RETURN TO INITIAL POSITION
                      0.01,  0.00,  0.00;   %% state ==  7  COM TRANSITION TO RIGHT FOOT
                      0.01,  0.00,  0.00;   %% state ==  8  RIGHT FOOT BALANCING 
                      0.01,  0.00,  0.00;   %% state ==  9  PREPARING FOR SWITCHING
                      0.01,  0.015,-0.01;   %% state == 10  LOOKING FOR CONTACT
                      0.01,  0.00,  0.00];  %% state == 11  TRANSITION INIT POSITION: THIS REFERENCE IS IGNORED
