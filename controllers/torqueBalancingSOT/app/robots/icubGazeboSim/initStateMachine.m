...
if strcmpi(SM.SM_TYPE, 'YOGA')
    ...
    gain.PCOM     =    [10    30  10  % state ==  1  TWO FEET BALANCING
                        ...
                        10    50  10  % state ==  4  PREPARING FOR SWITCHING 
                        10    50  10  % state ==  5  LOOKING FOR CONTACT
                        10    50  10  % state ==  6  TRANSITION TO INITIAL POSITION 
                        10    50  10  % state ==  7  COM TRANSITION TO RIGHT FOOT
                        10    50  10  % state ==  8  RIGHT FOOT BALANCING
    ...
    gain.impedances  = [20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  1  TWO FEET BALANCING
                        ...
                        20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  4  PREPARING FOR SWITCHING 
                        20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  5  LOOKING FOR CONTACT
                        20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  6  TRANSITION TO INITIAL POSITION 
                        20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  7  COM TRANSITION TO RIGHT FOOT
                        20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  8  RIGHT FOOT BALANCING
                        20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  9  PREPARING FOR SWITCHING 
                        20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50  % state == 10  LOOKING FOR CONTACT
                        20   30   20, 12   12    12   12 10, 12   12    12   12 10, 30   50   30    60     50  50, 30   50   30    60     50  50];% state == 11  TRANSITION TO INITIAL POSITION
...
sm.jointsSmoothingTimes          = [5;   %% state ==  1  TWO FEET BALANCING
                                    ...
                                    2;   %% state ==  6  TRANSITION INIT POSITION
                                         %%
                                    3;   %% state ==  7  COM TRANSITION TO RIGHT FOOT
                                    3;   %% state ==  8  RIGHT FOOT BALANCING 
...
sm.com.states      = [0.01,  0.00,0.0;   %% state ==  1  TWO FEET BALANCING NOT USED
                      ...
                      0.01, -0.09,0.0;   %% state ==  5  LOOKING FOR CONTACT 
                      ...
                      0.01,  0.09,0.0;   %% state == 10  LOOKING FOR CONTACT 
...
sm.origin.leftFoot = [0.0,  0.00, 0.0;   %% state ==  1  TWO FEET BALANCING NOT USED  : THIS REFERENCE IS IGNORED
                      ...
                      0.0,  0.00, 0.05;  %% state ==  3  LEFT FOOT BALANCING          : THIS REFERENCE IS IGNORED
...
sm.origin.rightFoot =[0.0,  0.00, 0.0;   %% state ==  1  TWO FEET BALANCING NOT USED  : THIS REFERENCE IS IGNORED
                      ...
                      0.0,  0.00, 0.0;   %% state ==  6  TRANSITION INIT POSITION     : THIS REFERENCE IS IGNORED
                      0.0,  0.00, 0.0;   %% state ==  7  COM TRANSITION TO RIGHT FOOT : THIS REFERENCE IS IGNORED
                      0.0,  0.00, 0.05;  %% state ==  8  RIGHT FOOT BALANCING         : THIS REFERENCE IS IGNORED
