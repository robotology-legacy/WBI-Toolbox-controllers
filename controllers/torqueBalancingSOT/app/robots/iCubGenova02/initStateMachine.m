...
if strcmpi(SM.SM_TYPE, 'YOGA')
    ...
    gain.PCOM     =    [10    30  10  % state ==  1  TWO FEET BALANCING
                        10    30  10  % state ==  2  COM TRANSITION TO LEFT 
                        10    30  10  % state ==  3  LEFT FOOT BALANCING
                        10    30  10  % state ==  4  YOGA LEFT FOOT 
    ...
    gain.impedances  = [20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  1  TWO FEET BALANCING
                        ...
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  4  YOGA LEFT FOOT 
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  5  PREPARING FOR SWITCHING 
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  6  LOOKING FOR CONTACT
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  7  TRANSITION TO INITIAL POSITION 
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  8  COM TRANSITION TO RIGHT FOOT
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  9  RIGHT FOOT BALANCING
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state == 10  YOGA RIGHT FOOT 
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state == 11  PREPARING FOR SWITCHING 
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50  % state == 12  LOOKING FOR CONTACT
                        20   30   20, 12   12    12   12, 12   12    12   12, 30   50   30    60     50  50, 30   50   30    60     50  50];% state == 13  TRANSITION TO INITIAL POSITION
                    
    gain.rootPD      = [30 2];

    gain.lFoot.posPD = [30*ones(3,1),2*sqrt(ones(3,1))];
    gain.lFoot.rotPD = [30,2];
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                      
gain.rootPD      = gain.rootPD/30;

gain.lFoot.posPD = gain.lFoot.posPD/30;
gain.lFoot.rotPD = gain.lFoot.rotPD /30;

gain.rFoot.posPD = gain.rFoot.posPD/30;
gain.rFoot.rotPD = gain.rFoot.rotPD/30;
    
gain.PCOM  = gain.PCOM/10;
gain.ICOM  = gain.PCOM*0;
gain.DCOM  = sqrt(gain.PCOM)/10;

gain.impedances = gain.impedances/30;         
gain.dampings   = sqrt(gain.impedances(1,:))/30;

sat.torqueDot   = 500*ones(ROBOT_DOF,1);
...
sm.joints                        = struct;
sm.joints.thresholdNotInContact  = 25;    % Degrees
...
sm.jointsSmoothingTimes          = [5;   %% state ==  1  TWO FEET BALANCING
                                         %%
                                    7;   %% state ==  2  COM TRANSITION TO LEFT FOOT
                                    1;   %% state ==  3  LEFT FOOT BALANCING 
                                    3;   %% state ==  4  YOGA LEFT FOOT
                                    1;   %% state ==  5  PREPARING FOR SWITCHING
                                    1;   %% state ==  6  LOOKING FOR CONTACT 
                                         %%
                                    7;   %% state ==  7  TRANSITION INIT POSITION
                                         %%
                                    7;   %% state ==  8  COM TRANSITION TO RIGHT FOOT
                                    3;   %% state ==  9  RIGHT FOOT BALANCING 
                                    3;   %% state == 10  YOGA RIGHT FOOT
                                    1;   %% state == 11  PREPARING FOR SWITCHING
