...
function [tauModel,Sigma,NA,f_HDot, ...
          ...
          errorCoM,qTilde,f]    =  ...
              balancingControllerSOT(constraints,ROBOT_DOF_FOR_SIMULINK,ConstraintsMatrix,bVectorConstraints,...
    ...
    %
    % Then, the dynamic equations of the system write
    %
    % 2)  M(q)nuD + h(q,nu) = Bu
    %
    % with 
