...
% 
%  - available Matlab versions: 2017a, 2016b, 2015b, 2015a, 2012b
%
...
modelName         = ['BoundedTorqueControl' versionName];
...
try
  ...
  save_system(modelName, 'BoundedTorqueControlR2012bS80', 'ExportToVersion', 'R2012B_MDl');

  if str2double(matlabVersion) >= 8.6  
      % export to 2015a
      fprintf('\nExporting to version 2015a\n');
      save_system(modelName, 'BoundedTorqueControlR2015aS85', 'ExportToVersion', 'R2015A_MDl');

  end 
  if str2double(matlabVersion) >= 9.1    
      % export to 2015b
      fprintf('\nExporting to version 2015b\n'); 
      save_system(modelName, 'BoundedTorqueControlR2015bS86', 'ExportToVersion', 'R2015B_MDl');
      % export to 2016b
      fprintf('\nExporting to version 2016b\n'); 
      save_system(modelName, 'BoundedTorqueControlR2016bS88', 'ExportToVersion', 'R2016B_MDl');
  end
  % closing the model
