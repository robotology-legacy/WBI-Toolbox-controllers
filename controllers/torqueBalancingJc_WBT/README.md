...
This module implements a torque control balancing strategy. It controls the robot directly in the joint space, without considering the 
centroidal dynamics. Torques are calculated to asymptotically stabilize joints accelerations, while the reference is calculated using an
