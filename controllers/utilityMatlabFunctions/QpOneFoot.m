...
block.InputPort(2).Dimensions        = [ 6  6];   % HessianMatrixQP2Feet               
block.InputPort(3).Dimensions        = [ 1  6];   % gradientQP2Feet
block.InputPort(4).Dimensions        = [19  6];   % ConstraintsMatrixQP2Feet 
block.InputPort(5).Dimensions        = [ 1 19];   % bVectorConstraintsQp2Feet 
block.InputPort(6).Dimensions        = 1;   % USE_QP_OASES
...
block.OutputPort(2).DatatypeID  = 0; % double %8; % boolean
