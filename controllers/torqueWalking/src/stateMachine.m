function [desired_x_dx_ddx_CoM, desired_R_w_dw_CoM, desired_s_ds_dds] = stateMachine(s0, w_H_CoM_0, ROBOT_DOF)

% Keep initial CoM position + a desired displacement
CoM_displacement = [0; -0.05; 0];
...
desired_R_w_dw_CoM = [w_H_CoM_0(1:3,1:3), zeros(3,2)];
