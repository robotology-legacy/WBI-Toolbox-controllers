...
#include "c8_balancingOptTauQpExtWrenches.h"
...
static void initialize_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void initialize_params_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void enable_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void disable_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void set_sim_state_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c8_st);
static void finalize_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void sf_gateway_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void c8_chartstep_c8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void initSimStructsc8_balancingOptTauQpExtWrenches
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_balancingOptTauQpExtWrenchesInstanceStruct *
...
static void c8_b_emlrt_marshallIn
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[23]);
...
static void c8_f_emlrt_marshallIn
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[4]);
...
static uint8_T c8_i_emlrt_marshallIn
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c8_b_is_active_c8_balancingOptTauQpExtWrenches, const char_T *c8_identifier);
  ...
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_balancingOptTauQpExtWrenches = 0U;
}
  ...
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_balancingOptTauQpExtWrenches;
   ...
   *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_balancingOptTauQpExtWrenches =
    c8_i_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
    "is_active_c8_balancingOptTauQpExtWrenches");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_balancingOptTauQpExtWrenches(chartInstance);
  ...
  (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_balancingOptTauQpExtWrenches(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance;
  chartInstance = (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *)
    chartInstanceVoid;
   ...
   *c8_b_is_active_c8_balancingOptTauQpExtWrenches, const char_T *c8_identifier)
{
  ...
  c8_y = c8_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_balancingOptTauQpExtWrenches), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_balancingOptTauQpExtWrenches);
  return c8_y;
}
...
void sf_c8_balancingOptTauQpExtWrenches_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_balancingOptTauQpExtWrenches_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_balancingOptTauQpExtWrenches_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_balancingOptTauQpExtWrenches_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_balancingOptTauQpExtWrenches(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[26],T\"nonlinearImpedences\",},{M[8],M[0],T\"is_active_c8_balancingOptTauQpExtWrenches\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_balancingOptTauQpExtWrenches_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_balancingOptTauQpExtWrenches
    ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
  initialize_c8_balancingOptTauQpExtWrenches
    ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  enable_c8_balancingOptTauQpExtWrenches
    ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  disable_c8_balancingOptTauQpExtWrenches
    ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  sf_gateway_c8_balancingOptTauQpExtWrenches
    ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_balancingOptTauQpExtWrenches
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_balancingOptTauQpExtWrenches
    ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_balancingOptTauQpExtWrenches();/* state var info */
...
extern void sf_internal_set_sim_state_c8_balancingOptTauQpExtWrenches(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_balancingOptTauQpExtWrenches();/* state var info */
  ...
  set_sim_state_c8_balancingOptTauQpExtWrenches
    ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_balancingOptTauQpExtWrenches
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c8_balancingOptTauQpExtWrenches(S);
}

static void sf_opaque_set_sim_state_c8_balancingOptTauQpExtWrenches(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c8_balancingOptTauQpExtWrenches(S, st);
}

static void sf_opaque_terminate_c8_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_balancingOptTauQpExtWrenches
      ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_balancingOptTauQpExtWrenches
    ((SFc8_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_balancingOptTauQpExtWrenches(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_balancingOptTauQpExtWrenches(SimStruct *S)
{
...
static void mdlRTW_c8_balancingOptTauQpExtWrenches(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_balancingOptTauQpExtWrenches(SimStruct *S)
{
  SFc8_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_balancingOptTauQpExtWrenchesInstanceStruct *)utMalloc
    (sizeof(SFc8_balancingOptTauQpExtWrenchesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_balancingOptTauQpExtWrenches;
...
void c8_balancingOptTauQpExtWrenches_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_balancingOptTauQpExtWrenches(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_balancingOptTauQpExtWrenches(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_balancingOptTauQpExtWrenches(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_balancingOptTauQpExtWrenches_method_dispatcher.\n"
