...
#include "c3_balancingOptTauQpExtWrenches.h"
...
static void initialize_c3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void initialize_params_c3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void enable_c3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void disable_c3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void set_sim_state_c3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void sf_gateway_c3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void initSimStructsc3_balancingOptTauQpExtWrenches
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_balancingOptTauQpExtWrenchesInstanceStruct *
...
static void c3_b_emlrt_marshallIn
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[9]);
...
static void c3_eml_scalar_eg(SFc3_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
...
static uint8_T c3_h_emlrt_marshallIn
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c3_b_is_active_c3_balancingOptTauQpExtWrenches, const char_T *c3_identifier);
  ...
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_balancingOptTauQpExtWrenches = 0U;
}
  ...
  (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_balancingOptTauQpExtWrenches;
   ...
   *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_balancingOptTauQpExtWrenches =
    c3_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
    "is_active_c3_balancingOptTauQpExtWrenches");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_balancingOptTauQpExtWrenches(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance;
  chartInstance = (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c3_balancingOptTauQpExtWrenches_get_eml_resolved_functions_info(void)
{
   ...
   *c3_b_is_active_c3_balancingOptTauQpExtWrenches, const char_T *c3_identifier)
{
  ...
  c3_y = c3_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_balancingOptTauQpExtWrenches), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_balancingOptTauQpExtWrenches);
  return c3_y;
}
...
void sf_c3_balancingOptTauQpExtWrenches_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_balancingOptTauQpExtWrenches_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_balancingOptTauQpExtWrenches_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_balancingOptTauQpExtWrenches_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_balancingOptTauQpExtWrenches(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"desired_x_dx_ddx_CoM\",},{M[8],M[0],T\"is_active_c3_balancingOptTauQpExtWrenches\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_balancingOptTauQpExtWrenches_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_balancingOptTauQpExtWrenches
    ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
  initialize_c3_balancingOptTauQpExtWrenches
    ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  enable_c3_balancingOptTauQpExtWrenches
    ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  disable_c3_balancingOptTauQpExtWrenches
    ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  sf_gateway_c3_balancingOptTauQpExtWrenches
    ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_balancingOptTauQpExtWrenches
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_balancingOptTauQpExtWrenches
    ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_balancingOptTauQpExtWrenches();/* state var info */
...
extern void sf_internal_set_sim_state_c3_balancingOptTauQpExtWrenches(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_balancingOptTauQpExtWrenches();/* state var info */
  ...
  set_sim_state_c3_balancingOptTauQpExtWrenches
    ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_balancingOptTauQpExtWrenches
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_balancingOptTauQpExtWrenches(S);
}

static void sf_opaque_set_sim_state_c3_balancingOptTauQpExtWrenches(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_balancingOptTauQpExtWrenches(S, st);
}

static void sf_opaque_terminate_c3_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_balancingOptTauQpExtWrenches
      ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_balancingOptTauQpExtWrenches
    ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_balancingOptTauQpExtWrenches(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_balancingOptTauQpExtWrenches
      ((SFc3_balancingOptTauQpExtWrenchesInstanceStruct*)
       (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_balancingOptTauQpExtWrenches(SimStruct *S)
{
...
static void mdlRTW_c3_balancingOptTauQpExtWrenches(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_balancingOptTauQpExtWrenches(SimStruct *S)
{
  SFc3_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_balancingOptTauQpExtWrenchesInstanceStruct *)utMalloc
    (sizeof(SFc3_balancingOptTauQpExtWrenchesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_balancingOptTauQpExtWrenches;
...
void c3_balancingOptTauQpExtWrenches_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_balancingOptTauQpExtWrenches(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_balancingOptTauQpExtWrenches(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_balancingOptTauQpExtWrenches(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_balancingOptTauQpExtWrenches_method_dispatcher.\n"
