...
#include <stddef.h>
#include "blas.h"
#include "balancingOptTauQpExtWrenches_sfun.h"
#include "c2_balancingOptTauQpExtWrenches.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "balancingOptTauQpExtWrenches_sfun_debug_macros.h"
...
static const char * c2_debug_family_names[8] = { "Jc", "nargin", "nargout",
  "JcLeftFoot", "JcRightFoot", "activeFeetConstraints", "qD", "y" };

/* Function Declarations */
static void initialize_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void initialize_params_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void enable_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void disable_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void set_sim_state_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void sf_gateway_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void c2_chartstep_c2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void initSimStructsc2_balancingOptTauQpExtWrenches
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_balancingOptTauQpExtWrenchesInstanceStruct *
...
static void c2_d_emlrt_marshallIn
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y_data[], int32_T
   c2_y_sizes[2]);
...
static real_T c2_sum(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
                     *chartInstance, real_T c2_x[2]);
static void c2_pinv(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
                    *chartInstance, real_T c2_A_data[], int32_T c2_A_sizes[2],
                    real_T c2_X_data[], int32_T c2_X_sizes[2]);
static void c2_eml_switch_helper(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_check_forloop_overflow_error
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, boolean_T
   c2_overflow);
static boolean_T c2_isfinite(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_x);
static void c2_eml_error(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_eml_scalar_eg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_threshold(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static real_T c2_abs(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
                     *chartInstance, real_T c2_x);
static void c2_realmin(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static real_T c2_eml_div(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_x, real_T c2_y);
static void c2_b_threshold(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_c_threshold(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_d_threshold(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static real_T c2_eml_xdotc(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2],
  int32_T c2_ix0, real_T c2_y_data[], int32_T c2_y_sizes[2], int32_T c2_iy0);
static void c2_scalarEg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y_data[],
  int32_T c2_y_sizes[2], int32_T c2_iy0, real_T c2_b_y_data[], int32_T
  c2_b_y_sizes[2]);
static void c2_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2],
  int32_T c2_ix0, real_T c2_b_x_data[], int32_T c2_b_x_sizes[2]);
static void c2_b_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T
  c2_x_sizes[2], int32_T c2_ix0, real_T c2_b_x_data[], int32_T c2_b_x_sizes[2]);
static void c2_eps(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
                   *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_b_eml_error(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static real_T c2_sqrt(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
                      *chartInstance, real_T c2_x);
static void c2_c_eml_error(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_eml_xrotg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_a, real_T c2_b, real_T *c2_b_a, real_T *c2_b_b,
  real_T *c2_c, real_T *c2_s);
static void c2_eml_xrot(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2],
  int32_T c2_ix0, int32_T c2_iy0, real_T c2_c, real_T c2_s, real_T c2_b_x_data[],
  int32_T c2_b_x_sizes[2]);
static void c2_e_threshold(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_eml_xswap(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2],
  int32_T c2_ix0, int32_T c2_iy0, real_T c2_b_x_data[], int32_T c2_b_x_sizes[2]);
static void c2_f_threshold(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_d_eml_scalar_eg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_eml_xgesvd(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_A_data[], int32_T c2_A_sizes[2], real_T c2_U_data[],
  int32_T c2_U_sizes[2], real_T c2_S_data[], int32_T *c2_S_sizes, real_T
  c2_V_data[], int32_T c2_V_sizes[2]);
static real_T c2_eml_xnrm2(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2],
  int32_T c2_ix0);
static void c2_c_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T
  c2_x_sizes[2], int32_T c2_ix0, real_T c2_b_x_data[], int32_T c2_b_x_sizes[2]);
static real_T c2_b_eml_xdotc(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2],
  int32_T c2_ix0, real_T c2_y_data[], int32_T c2_y_sizes[2], int32_T c2_iy0);
static void c2_b_scalarEg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_b_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y_data[],
  int32_T c2_y_sizes[2], int32_T c2_iy0, real_T c2_b_y_data[], int32_T
  c2_b_y_sizes[2]);
static real_T c2_b_eml_xnrm2(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[6], int32_T c2_ix0);
static void c2_d_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x[6], int32_T c2_ix0,
  real_T c2_b_x[6]);
static void c2_c_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T
  c2_x_sizes[2], int32_T c2_ix0, real_T c2_y_data[], int32_T c2_y_sizes, int32_T
  c2_iy0, real_T c2_b_y_data[], int32_T *c2_b_y_sizes);
static void c2_d_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T
  c2_x_sizes, int32_T c2_ix0, real_T c2_y_data[], int32_T c2_y_sizes[2], int32_T
  c2_iy0, real_T c2_b_y_data[], int32_T c2_b_y_sizes[2]);
static real_T c2_c_eml_xdotc(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x[36], int32_T c2_ix0, real_T c2_y[36],
  int32_T c2_iy0);
static void c2_e_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y[36],
  int32_T c2_iy0, real_T c2_b_y[36]);
static void c2_e_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_a, real_T c2_x[36], int32_T c2_ix0, real_T c2_b_x[36]);
static void c2_b_eml_xrot(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_x[36], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c,
  real_T c2_s, real_T c2_b_x[36]);
static void c2_e_eml_scalar_eg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_b_eml_xswap(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_x[36], int32_T c2_ix0, int32_T c2_iy0, real_T
  c2_b_x[36]);
static void c2_g_threshold(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_eml_xgemm(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, int32_T c2_k, real_T c2_A_data[], int32_T
  c2_A_sizes[2], real_T c2_B_data[], int32_T c2_B_sizes[2], int32_T c2_ldb,
  real_T c2_C_data[], int32_T c2_C_sizes[2], real_T c2_b_C_data[], int32_T
  c2_b_C_sizes[2]);
static void c2_f_eml_scalar_eg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
static void c2_b_eml_xgemm(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_k, real_T c2_A_data[], int32_T c2_A_sizes[2],
  real_T c2_B_data[], int32_T c2_B_sizes[2], int32_T c2_ldb, real_T c2_C[138],
  real_T c2_b_C[138]);
static void c2_g_eml_scalar_eg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance);
...
static uint8_T c2_f_emlrt_marshallIn
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_balancingOptTauQpExtWrenches, const char_T *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_f_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y_data[],
  int32_T c2_y_sizes[2], int32_T c2_iy0);
static void c2_f_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2],
  int32_T c2_ix0);
static void c2_g_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T
  c2_x_sizes[2], int32_T c2_ix0);
static void c2_b_sqrt(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
                      *chartInstance, real_T *c2_x);
static void c2_b_eml_xrotg(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T *c2_a, real_T *c2_b, real_T *c2_c, real_T *c2_s);
static void c2_c_eml_xrot(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2],
  int32_T c2_ix0, int32_T c2_iy0, real_T c2_c, real_T c2_s);
static void c2_c_eml_xswap(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2],
  int32_T c2_ix0, int32_T c2_iy0);
static void c2_h_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T
  c2_x_sizes[2], int32_T c2_ix0);
static void c2_g_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y_data[],
  int32_T c2_y_sizes[2], int32_T c2_iy0);
static void c2_i_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x[6], int32_T c2_ix0);
static void c2_h_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T
  c2_x_sizes[2], int32_T c2_ix0, real_T c2_y_data[], int32_T *c2_y_sizes,
  int32_T c2_iy0);
static void c2_i_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T
  c2_x_sizes, int32_T c2_ix0, real_T c2_y_data[], int32_T c2_y_sizes[2], int32_T
  c2_iy0);
static void c2_j_eml_xaxpy(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y[36],
  int32_T c2_iy0);
static void c2_j_eml_xscal(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_a, real_T c2_x[36], int32_T c2_ix0);
static void c2_d_eml_xrot(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_x[36], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c,
  real_T c2_s);
static void c2_d_eml_xswap(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, real_T c2_x[36], int32_T c2_ix0, int32_T c2_iy0);
static void c2_c_eml_xgemm(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_n, int32_T c2_k, real_T c2_A_data[], int32_T
  c2_A_sizes[2], real_T c2_B_data[], int32_T c2_B_sizes[2], int32_T c2_ldb,
  real_T c2_C_data[], int32_T c2_C_sizes[2]);
static void c2_d_eml_xgemm(SFc2_balancingOptTauQpExtWrenchesInstanceStruct
  *chartInstance, int32_T c2_k, real_T c2_A_data[], int32_T c2_A_sizes[2],
  real_T c2_B_data[], int32_T c2_B_sizes[2], int32_T c2_ldb, real_T c2_C[138]);
  ...
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_balancingOptTauQpExtWrenches = 0U;
}
  ...
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_balancingOptTauQpExtWrenches;
   ...
   *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_balancingOptTauQpExtWrenches =
    c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
    "is_active_c2_balancingOptTauQpExtWrenches");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_balancingOptTauQpExtWrenches(chartInstance);
  ...
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance)
{
  ...
  for (c2_i4 = 0; c2_i4 < 2; c2_i4++) {
    _SFD_DATA_RANGE_CHECK((*c2_activeFeetConstraints)[c2_i4], 2U);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_balancingOptTauQpExtWrenches(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_balancingOptTauQpExtWrenchesMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c2_i5 = 0; c2_i5 < 6; c2_i5++) {
    _SFD_DATA_RANGE_CHECK((*c2_y)[c2_i5], 3U);
  }

  for (c2_i6 = 0; c2_i6 < 23; c2_i6++) {
    _SFD_DATA_RANGE_CHECK((*c2_qD)[c2_i6], 4U);
  }
}
  ...
  (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance)
{
  ...
  real_T c2_y[6];
  int32_T c2_i11;
  real_T c2_b_activeFeetConstraints[2];
  int32_T c2_i12;
  int32_T c2_i13;
  int32_T c2_i14;
  int32_T c2_i15;
  ...
  for (c2_i7 = 0; c2_i7 < 174; c2_i7++) {
    c2_JcLeftFoot[c2_i7] = (*c2_c_JcLeftFoot)[c2_i7];
  }

  for (c2_i8 = 0; c2_i8 < 174; c2_i8++) {
    c2_JcRightFoot[c2_i8] = (*c2_b_JcRightFoot)[c2_i8];
  }

  for (c2_i9 = 0; c2_i9 < 2; c2_i9++) {
    c2_activeFeetConstraints[c2_i9] = (*c2_c_activeFeetConstraints)[c2_i9];
  }

  for (c2_i10 = 0; c2_i10 < 23; c2_i10++) {
    c2_qD[c2_i10] = (*c2_b_qD)[c2_i10];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_DYN_IMPORTABLE(c2_Jc_data, (const int32_T *)
    &c2_Jc_sizes, NULL, 0, 0, (void *)c2_f_sf_marshallOut, (void *)
    c2_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_activeFeetConstraints, 5U, c2_c_sf_marshallOut);
  ...
  for (c2_i11 = 0; c2_i11 < 2; c2_i11++) {
    c2_b_activeFeetConstraints[c2_i11] = c2_activeFeetConstraints[c2_i11];
  }

  if (CV_EML_IF(0, 1, 0, c2_sum(chartInstance, c2_b_activeFeetConstraints) ==
                2.0)) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 4);
    c2_i12 = 0;
    c2_i13 = 0;
    for (c2_i14 = 0; c2_i14 < 29; c2_i14++) {
      for (c2_i15 = 0; c2_i15 < 6; c2_i15++) {
        c2_b_JcLeftFoot[c2_i15 + c2_i12] = c2_JcLeftFoot[c2_i15 + c2_i13];
      }
    ...
    c2_i16 = 0;
    c2_i17 = 0;
    for (c2_i18 = 0; c2_i18 < 29; c2_i18++) {
      for (c2_i19 = 0; c2_i19 < 6; c2_i19++) {
        c2_b_JcLeftFoot[(c2_i19 + c2_i16) + 6] = c2_JcRightFoot[c2_i19 + c2_i17];
      }
    ...
    for (c2_i20 = 0; c2_i20 < 348; c2_i20++) {
      c2_Jc_data[c2_i20] = c2_b_JcLeftFoot[c2_i20];
    }
  } else {
    ...
    for (c2_i21 = 0; c2_i21 < 174; c2_i21++) {
      c2_Jc_data[c2_i21] = c2_JcLeftFoot[c2_i21];
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 8);
  c2_i22 = c2_Jc_sizes[0];
  c2_b_Jc_sizes[0] = c2_i22;
  c2_b_Jc_sizes[1] = 6;
  for (c2_i23 = 0; c2_i23 < 6; c2_i23++) {
    c2_loop_ub = c2_i22 - 1;
    for (c2_i24 = 0; c2_i24 <= c2_loop_ub; c2_i24++) {
      c2_b_Jc_data[c2_i24 + c2_b_Jc_sizes[0] * c2_i23] = c2_Jc_data[c2_i24 +
        c2_Jc_sizes[0] * c2_i23];
    }
  }
  ...
  for (c2_i25 = 0; c2_i25 <= c2_b_loop_ub; c2_i25++) {
    c2_a_data[c2_i25] = -c2_a_data[c2_i25];
  }

  c2_i26 = c2_Jc_sizes[0];
  c2_b_sizes[0] = c2_i26;
  c2_b_sizes[1] = 23;
  for (c2_i27 = 0; c2_i27 < 23; c2_i27++) {
    c2_c_loop_ub = c2_i26 - 1;
    for (c2_i28 = 0; c2_i28 <= c2_c_loop_ub; c2_i28++) {
      c2_b_data[c2_i28 + c2_b_sizes[0] * c2_i27] = c2_Jc_data[c2_i28 +
        c2_Jc_sizes[0] * (6 + c2_i27)];
    }
  }

  c2_innerDimOk = ((real_T)c2_a_sizes[1] == (real_T)c2_b_sizes[0]);
  if (!c2_innerDimOk) {
    for (c2_i29 = 0; c2_i29 < 21; c2_i29++) {
      c2_u[c2_i29] = c2_cv0[c2_i29];
    }
  ...
  c2_f_eml_scalar_eg(chartInstance);
  for (c2_i30 = 0; c2_i30 < 138; c2_i30++) {
    c2_c_y[c2_i30] = 0.0;
  }
  ...
  for (c2_i31 = 0; c2_i31 <= c2_d_loop_ub; c2_i31++) {
    c2_b_a_data[c2_i31] = c2_a_data[c2_i31];
  }
  ...
  for (c2_i36 = 0; c2_i36 < 6; c2_i36++) {
    c2_C[c2_i36] = c2_y[c2_i36];
  }

  for (c2_i37 = 0; c2_i37 < 6; c2_i37++) {
    c2_y[c2_i37] = c2_C[c2_i37];
  }

  c2_f_threshold(chartInstance);
  for (c2_i38 = 0; c2_i38 < 6; c2_i38++) {
    c2_C[c2_i38] = c2_y[c2_i38];
  }

  for (c2_i39 = 0; c2_i39 < 6; c2_i39++) {
    c2_y[c2_i39] = c2_C[c2_i39];
  }

  for (c2_i40 = 0; c2_i40 < 6; c2_i40++) {
    c2_y[c2_i40] = 0.0;
    c2_i41 = 0;
    for (c2_i42 = 0; c2_i42 < 23; c2_i42++) {
      c2_y[c2_i40] += c2_c_y[c2_i41 + c2_i40] * c2_c_b[c2_i42];
      c2_i41 += 6;
    }
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance;
  chartInstance = (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *)
    chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i44 = 0; c2_i44 < 6; c2_i44++) {
    c2_b_inData[c2_i44] = (*(real_T (*)[6])c2_inData)[c2_i44];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i47 = 0; c2_i47 < 6; c2_i47++) {
    (*(real_T (*)[6])c2_outData)[c2_i47] = c2_b_y[c2_i47];
  }
  ...
  *c2_inData)
{
  ...
  chartInstance = (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *)
    chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i48 = 0; c2_i48 < 23; c2_i48++) {
    c2_b_inData[c2_i48] = (*(real_T (*)[23])c2_inData)[c2_i48];
  }

  for (c2_i49 = 0; c2_i49 < 23; c2_i49++) {
  ...
  *c2_inData)
{
  ...
  for (c2_i53 = 0; c2_i53 < 29; c2_i53++) {
    for (c2_i54 = 0; c2_i54 < 6; c2_i54++) {
      c2_b_inData[c2_i54 + c2_i52] = (*(real_T (*)[174])c2_inData)[c2_i54 +
        c2_i52];
    }
  ...
  c2_inData_data[], int32_T c2_inData_sizes[2])
{
  ...
  for (c2_i58 = 0; c2_i58 < 29; c2_i58++) {
    c2_loop_ub = c2_inData_sizes[0] - 1;
    for (c2_i59 = 0; c2_i59 <= c2_loop_ub; c2_i59++) {
      c2_b_inData_data[c2_i59 + c2_b_inData_sizes[0] * c2_i58] =
        c2_inData_data[c2_i59 + c2_inData_sizes[0] * c2_i58];
    }
  }
  ...
  for (c2_i60 = 0; c2_i60 < 29; c2_i60++) {
    ...
    for (c2_i61 = 0; c2_i61 <= c2_b_loop_ub; c2_i61++) {
      c2_u_data[c2_i61 + c2_u_sizes[0] * c2_i60] = c2_b_inData_data[c2_i61 +
        c2_b_inData_sizes[0] * c2_i60];
    }
  }
   ...
   c2_y_sizes[2])
{
  ...
  for (c2_i62 = 0; c2_i62 < 2; c2_i62++) {
    c2_uv0[c2_i62] = 12U + 17U * (uint32_T)c2_i62;
  }

  for (c2_i63 = 0; c2_i63 < 2; c2_i63++) {
    c2_bv1[c2_i63] = c2_bv0[c2_i63];
  }
  ...
  c2_outData_sizes[2])
{
  ...
  for (c2_i65 = 0; c2_i65 < 29; c2_i65++) {
    c2_loop_ub = c2_y_sizes[0] - 1;
    for (c2_i66 = 0; c2_i66 <= c2_loop_ub; c2_i66++) {
      c2_outData_data[c2_i66 + c2_outData_sizes[0] * c2_i65] = c2_y_data[c2_i66
        + c2_y_sizes[0] * c2_i65];
    }
  }
...
const mxArray
  *sf_c2_balancingOptTauQpExtWrenches_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  c2_nameCaptureInfo = NULL;
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 220, 1),
                false);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("pinv"), "name", "name", 9);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/pinv.m!eml_pinv"),
                  "context", "context", 12);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("svd"), "name", "name", 12);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"),
                  "context", "context", 41);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("max"), "name", "name", 41);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 41);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m!is_signed_indexIntClass"),
                  "context", "context", 51);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("intmin"), "name", "name", 51);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m!eml_scalar_bin_extremum"),
                  "context", "context", 53);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isnan"), "name", "name", 53);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"),
                  "context", "context", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("max"), "name", "name", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("coder.internal.indexInt"),
...
static void c2_b_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 71);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 71);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 71);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xscal.p"),
                  "context", "context", 89);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "coder.internal.blas.use_refblas"), "name", "name", 89);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 89);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/use_refblas.p"),
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xaxpy.p"),
                  "context", "context", 119);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "coder.internal.blas.use_refblas"), "name", "name", 119);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 119);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/use_refblas.p"),
...
static void c2_c_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xaxpy.p!below_threshold"),
                  "context", "context", 131);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("length"), "name", "name", 131);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 131);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 132);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("intmin"), "name", "name", 132);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 132);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"),
                  "context", "context", 134);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("realmin"), "name", "name", 134);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 134);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m!eml_extremum_sub"),
                  "context", "context", 145);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isnan"), "name", "name", 145);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 145);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zsvdc.m"),
                  "context", "context", 149);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("sqrt"), "name", "name", 149);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 149);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xrotg.p"),
                  "context", "context", 155);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "coder.internal.blas.use_refblas"), "name", "name", 155);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 155);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/use_refblas.p"),
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xrotg.p"),
                  "context", "context", 157);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 157);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 157);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 160);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("rdivide"), "name", "name", 160);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 160);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 163);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_div"), "name", "name", 163);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 163);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xrotg.p"),
                  "context", "context", 164);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("sqrt"), "name", "name", 164);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 164);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xswap.p"),
                  "context", "context", 182);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 182);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/pinv.m!eml_pinv"),
                  "context", "context", 187);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eps"), "name", "name", 187);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 187);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/pinv.m!eml_pinv"),
                  "context", "context", 190);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_div"), "name", "name", 190);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 190);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
...
static void c2_d_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xnrm2.p!below_threshold"),
                  "context", "context", 209);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("length"), "name", "name", 209);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 209);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xscal.p!below_threshold"),
                  "context", "context", 210);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("length"), "name", "name", 210);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 210);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xdot.p!below_threshold"),
                  "context", "context", 211);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("length"), "name", "name", 211);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 211);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, sf_mex_duplicatearraysafe(&c2_lhs214), "lhs", "lhs",
                  214);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(""), "context", "context", 215);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/eml_mtimes_helper.m!common_checks"),
                  "context", "context", 216);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "coder.internal.isBuiltInNumeric"), "name", "name", 216);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 216);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                    ...
                    real_T c2_X_data[], int32_T c2_X_sizes[2])
{
  ...
  for (c2_i67 = 0; c2_i67 <= c2_loop_ub; c2_i67++) {
    c2_X_data[c2_i67] = 0.0;
  }

  c2_i68 = c2_A_sizes[0] * 6;
  c2_b = c2_i68;
  c2_b_b = c2_b;
  if (1 > c2_b_b) {
    c2_overflow = false;
  ...
  for (c2_i69 = 0; c2_i69 <= c2_b_loop_ub; c2_i69++) {
    c2_b_A_data[c2_i69] = c2_A_data[c2_i69];
  }
  ...
  if (c2_r > 0) {
    ...
    for (c2_i71 = 0; c2_i71 < 36; c2_i71++) {
      c2_b_V_data[c2_i71] = c2_V_data[c2_i71];
    }
    ...
    for (c2_i72 = 0; c2_i72 <= c2_c_loop_ub; c2_i72++) {
      c2_b_U_data[c2_i72] = c2_U_data[c2_i72];
    }
   ...
   c2_overflow)
{
  ...
  (void)chartInstance;
  (void)c2_overflow;
  for (c2_i73 = 0; c2_i73 < 34; c2_i73++) {
    c2_u[c2_i73] = c2_cv1[c2_i73];
  }

  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 10, 0U, 1U, 0U, 2, 1, 34), false);
  for (c2_i74 = 0; c2_i74 < 23; c2_i74++) {
    c2_b_u[c2_i74] = c2_cv2[c2_i74];
  }
  ...
  *chartInstance)
{
  ...
  const mxArray *c2_y = NULL;
  (void)chartInstance;
  for (c2_i75 = 0; c2_i75 < 33; c2_i75++) {
    c2_u[c2_i75] = c2_cv3[c2_i75];
  }
  ...
  c2_b_y_sizes[2])
{
  ...
  for (c2_i76 = 0; c2_i76 <= c2_loop_ub; c2_i76++) {
    c2_b_y_data[c2_i76] = c2_y_data[c2_i76];
  }
  ...
  *chartInstance)
{
  ...
  for (c2_i80 = 0; c2_i80 < 30; c2_i80++) {
    c2_u[c2_i80] = c2_cv5[c2_i80];
  }

  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 10, 0U, 1U, 0U, 2, 1, 30), false);
  for (c2_i81 = 0; c2_i81 < 4; c2_i81++) {
    c2_b_u[c2_i81] = c2_cv6[c2_i81];
  }
  ...
  int32_T c2_b_x_sizes[2])
{
  ...
  for (c2_i82 = 0; c2_i82 <= c2_loop_ub; c2_i82++) {
    c2_b_x_data[c2_i82] = c2_x_data[c2_i82];
  }
  ...
  int32_T c2_ix0, int32_T c2_iy0, real_T c2_b_x_data[], int32_T c2_b_x_sizes[2])
{
  ...
  c2_b_x = c2_b_x_sizes[1];
  c2_loop_ub = c2_x_sizes[0] * c2_x_sizes[1] - 1;
  for (c2_i83 = 0; c2_i83 <= c2_loop_ub; c2_i83++) {
    c2_b_x_data[c2_i83] = c2_x_data[c2_i83];
  }
  ...
  c2_V_data[], int32_T c2_V_sizes[2])
{
  ...
  for (c2_i84 = 0; c2_i84 <= c2_loop_ub; c2_i84++) {
    c2_b_A_data[c2_i84] = c2_A_data[c2_i84];
  }
  ...
  for (c2_i87 = 0; c2_i87 <= c2_b_loop_ub; c2_i87++) {
    c2_work_data[c2_i87] = 0.0;
  }
  ...
  for (c2_i88 = 0; c2_i88 <= c2_c_loop_ub; c2_i88++) {
    c2_U_data[c2_i88] = 0.0;
  }

  for (c2_i89 = 0; c2_i89 < 36; c2_i89++) {
    c2_Vf[c2_i89] = 0.0;
  }
  ...
  c2_i_x = c2_c_xk;
  c2_eml_scalar_eg(chartInstance);
  c2_i90 = muIntScalarMax_sint32(c2_i_x, 4);
  c2_b = c2_i90;
  c2_b_b = c2_b;
  if (1 > c2_b_b) {
    c2_overflow = false;
  ...
  for (c2_q = 1; c2_q <= c2_i90; c2_q++) {
    ...
    if (c2_b_q <= c2_nct) {
      ...
      for (c2_i91 = 0; c2_i91 <= c2_d_loop_ub; c2_i91++) {
        c2_c_A_data[c2_i91] = c2_b_A_data[c2_i91];
      }
    ...
    for (c2_jj = c2_b_qp1; c2_jj < 7; c2_jj++) {
      ...
      if (c2_b_q <= c2_nct) {
        if (c2_s_data[_SFD_EML_ARRAY_BOUNDS_CHECK("", c2_b_q, 1, 6, 1, 0) - 1]
          ...
          for (c2_i92 = 0; c2_i92 <= c2_e_loop_ub; c2_i92++) {
            c2_d_A_data[c2_i92] = c2_b_A_data[c2_i92];
          }
          ...
          for (c2_i93 = 0; c2_i93 <= c2_f_loop_ub; c2_i93++) {
            c2_e_A_data[c2_i93] = c2_b_A_data[c2_i93];
          }
      ...
      if (c2_qp1 <= c2_n) {
        if (c2_e[c2_b_q - 1] != 0.0) {
          ...
          for (c2_c_jj = c2_d_qp1; c2_c_jj < 7; c2_c_jj++) {
            ...
            for (c2_i95 = 0; c2_i95 <= c2_g_loop_ub; c2_i95++) {
              c2_f_A_data[c2_i95] = c2_b_A_data[c2_i95];
            }
          ...
          for (c2_d_jj = c2_e_qp1; c2_d_jj < 7; c2_d_jj++) {
            ...
            for (c2_i96 = 0; c2_i96 <= c2_h_loop_ub; c2_i96++) {
              c2_b_work_data[c2_i96] = c2_work_data[c2_i96];
            }
  ...
  for (c2_d_q = c2_b_nct; c2_d_q > 0; c2_d_q--) {
    ...
    if (c2_s_data[_SFD_EML_ARRAY_BOUNDS_CHECK("", c2_b_q, 1, 6, 1, 0) - 1] !=
      ...
      for (c2_f_jj = c2_g_qp1; c2_f_jj < 7; c2_f_jj++) {
        ...
        for (c2_i97 = 0; c2_i97 <= c2_i_loop_ub; c2_i97++) {
          c2_b_U_data[c2_i97] = c2_U_data[c2_i97];
        }
        ...
        for (c2_i98 = 0; c2_i98 <= c2_j_loop_ub; c2_i98++) {
          c2_c_U_data[c2_i98] = c2_U_data[c2_i98];
        }
      ...
      for (c2_g_ii = 1; c2_g_ii <= c2_i99; c2_g_ii++) {
        c2_b_ii = c2_g_ii;
        c2_U_data[(_SFD_EML_ARRAY_BOUNDS_CHECK("", c2_b_ii, 1, c2_U_sizes[0], 1,
      ...
      if (c2_e[c2_b_q - 1] != 0.0) {
        ...
        for (c2_g_jj = c2_h_qp1; c2_g_jj < 7; c2_g_jj++) {
          ...
          for (c2_i100 = 0; c2_i100 < 36; c2_i100++) {
            c2_b_Vf[c2_i100] = c2_Vf[c2_i100];
          }

          for (c2_i101 = 0; c2_i101 < 36; c2_i101++) {
            c2_c_Vf[c2_i101] = c2_Vf[c2_i101];
          }
    ...
    if (c2_iter >= 75.0) {
      ...
      switch ((int32_T)c2_kase) {
       case 1:
        ...
        for (c2_k = c2_i103; c2_k >= c2_i_q; c2_k--) {
          c2_b_k = c2_k;
       ...
       case 3:
        ...
        if (c2_ixstart < 5) {
          ...
          for (c2_c_ix = c2_i104; c2_c_ix < 6; c2_c_ix++) {
            c2_b_ix = c2_c_ix;
  ...
  *c2_S_sizes = c2_tmp_sizes;
  ...
  c2_b_tmp_sizes[0] = 6;
  c2_b_tmp_sizes[1] = 6;
  c2_i106 = c2_b_tmp_sizes[0];
  c2_i107 = c2_b_tmp_sizes[1];
  for (c2_i108 = 0; c2_i108 < 36; c2_i108++) {
    c2_b_tmp_data[c2_i108] = 0.0;
  }

  for (c2_i109 = 0; c2_i109 < 2; c2_i109++) {
    c2_V_sizes[c2_i109] = c2_b_tmp_sizes[c2_i109];
  }
  ...
  c2_x_sizes[2], int32_T c2_ix0, real_T c2_b_x_data[], int32_T c2_b_x_sizes[2])
{
  ...
  for (c2_i110 = 0; c2_i110 <= c2_loop_ub; c2_i110++) {
    c2_b_x_data[c2_i110] = c2_x_data[c2_i110];
  }
  ...
  c2_b_y_sizes[2])
{
  ...
  c2_b_y = c2_b_y_sizes[1];
  c2_loop_ub = c2_y_sizes[0] * c2_y_sizes[1] - 1;
  for (c2_i111 = 0; c2_i111 <= c2_loop_ub; c2_i111++) {
    c2_b_y_data[c2_i111] = c2_y_data[c2_i111];
  }
  ...
  c2_iy0, real_T c2_b_y_data[], int32_T *c2_b_y_sizes)
{
  ...
  *c2_b_y_sizes = c2_y_sizes;
  ...
  for (c2_i113 = 0; c2_i113 <= c2_loop_ub; c2_i113++) {
    c2_b_y_data[c2_i113] = c2_y_data[c2_i113];
  }
  ...
  for (c2_i114 = 0; c2_i114 <= c2_b_loop_ub; c2_i114++) {
    c2_b_x_data[c2_i114] = c2_x_data[c2_i114];
  }
  ...
  c2_iy0, real_T c2_b_y_data[], int32_T c2_b_y_sizes[2])
{
  ...
  c2_b_y = c2_b_y_sizes[1];
  c2_loop_ub = c2_y_sizes[0] * c2_y_sizes[1] - 1;
  for (c2_i115 = 0; c2_i115 <= c2_loop_ub; c2_i115++) {
    c2_b_y_data[c2_i115] = c2_y_data[c2_i115];
  }

  c2_b_x_sizes = c2_x_sizes;
  c2_b_loop_ub = c2_x_sizes - 1;
  for (c2_i116 = 0; c2_i116 <= c2_b_loop_ub; c2_i116++) {
    c2_b_x_data[c2_i116] = c2_x_data[c2_i116];
  }
...
{
  int32_T c2_i120;
  for (c2_i120 = 0; c2_i120 < 36; c2_i120++) {
  ...
  c2_b_C_sizes[2])
{
  ...
  for (c2_i121 = 0; c2_i121 <= c2_loop_ub; c2_i121++) {
    c2_b_C_data[c2_i121] = c2_C_data[c2_i121];
  }
  ...
  c2_A = c2_b_A_sizes[0];
  c2_b_A = c2_b_A_sizes[1];
  for (c2_i122 = 0; c2_i122 < 36; c2_i122++) {
    c2_b_A_data[c2_i122] = c2_A_data[c2_i122];
  }
  ...
  for (c2_i123 = 0; c2_i123 <= c2_b_loop_ub; c2_i123++) {
    c2_b_B_data[c2_i123] = c2_B_data[c2_i123];
  }
  ...
  real_T c2_b_C[138])
{
  ...
  int32_T c2_i126;
  real_T c2_b_B_data[276];
  for (c2_i124 = 0; c2_i124 < 138; c2_i124++) {
    c2_b_C[c2_i124] = c2_C[c2_i124];
  }
  ...
  for (c2_i125 = 0; c2_i125 <= c2_loop_ub; c2_i125++) {
    c2_b_A_data[c2_i125] = c2_A_data[c2_i125];
  }
  ...
  c2_b_B = c2_b_B_sizes[1];
  c2_b_loop_ub = c2_B_sizes[0] * c2_B_sizes[1] - 1;
  for (c2_i126 = 0; c2_i126 <= c2_b_loop_ub; c2_i126++) {
    c2_b_B_data[c2_i126] = c2_B_data[c2_i126];
  }
   ...
   *c2_u, const emlrtMsgIdentifier *c2_parentId)
{
  ...
  int32_T c2_i127;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), &c2_i127, 1, 6, 0U, 0, 0U, 0);
  c2_y = c2_i127;
  sf_mex_destroy(&c2_u);
  return c2_y;
}
   ...
   *c2_b_is_active_c2_balancingOptTauQpExtWrenches, const char_T *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_balancingOptTauQpExtWrenches), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_balancingOptTauQpExtWrenches);
  return c2_y;
}
  ...
  int32_T c2_ix0)
{
  ...
  for (c2_k = c2_d_ix0; c2_k <= c2_i128; c2_k++) {
    c2_b_k = c2_k;
  ...
  *chartInstance, int32_T c2_n, real_T c2_a, real_T c2_x[6], int32_T c2_ix0)
{
  ...
  for (c2_k = c2_d_ix0; c2_k <= c2_i129; c2_k++) {
    c2_b_k = c2_k;
  ...
  *chartInstance, real_T c2_a, real_T c2_x[36], int32_T c2_ix0)
{
  ...
  for (c2_k = c2_d_ix0; c2_k <= c2_i131; c2_k++) {
    c2_b_k = c2_k;
...
void sf_c2_balancingOptTauQpExtWrenches_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2678023927U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3723063515U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2377013002U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(222795568U);
}

mxArray *sf_c2_balancingOptTauQpExtWrenches_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("p5skf1EO6MpFQSK2kXcOSG");
...
mxArray *sf_c2_balancingOptTauQpExtWrenches_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_balancingOptTauQpExtWrenches_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_balancingOptTauQpExtWrenches(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_balancingOptTauQpExtWrenches\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_balancingOptTauQpExtWrenches_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _balancingOptTauQpExtWrenchesMachineNumber_,
           2,
           1,
           1,
           0,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,213);
        _SFD_CV_INIT_EML_IF(0,1,0,76,110,146,175);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, *c2_activeFeetConstraints);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _balancingOptTauQpExtWrenchesMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "b795Ou8xiT19GkpB3d3bbF";
}

static void sf_opaque_initialize_c2_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_balancingOptTauQpExtWrenches
    ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
  initialize_c2_balancingOptTauQpExtWrenches
    ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  enable_c2_balancingOptTauQpExtWrenches
    ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  disable_c2_balancingOptTauQpExtWrenches
    ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  sf_gateway_c2_balancingOptTauQpExtWrenches
    ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_balancingOptTauQpExtWrenches
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_balancingOptTauQpExtWrenches
    ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_balancingOptTauQpExtWrenches();/* state var info */
...
extern void sf_internal_set_sim_state_c2_balancingOptTauQpExtWrenches(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_balancingOptTauQpExtWrenches();/* state var info */
  ...
  set_sim_state_c2_balancingOptTauQpExtWrenches
    ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_balancingOptTauQpExtWrenches
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_balancingOptTauQpExtWrenches(S);
}

static void sf_opaque_set_sim_state_c2_balancingOptTauQpExtWrenches(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_balancingOptTauQpExtWrenches(S, st);
}

static void sf_opaque_terminate_c2_balancingOptTauQpExtWrenches(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_balancingOptTauQpExtWrenches_optimization_info();
    }

    finalize_c2_balancingOptTauQpExtWrenches
      ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_balancingOptTauQpExtWrenches
    ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_balancingOptTauQpExtWrenches(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_balancingOptTauQpExtWrenches
      ((SFc2_balancingOptTauQpExtWrenchesInstanceStruct*)
       (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_balancingOptTauQpExtWrenches(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_balancingOptTauQpExtWrenches_optimization_info();
  ...
  ssSetChecksum0(S,(2825413924U));
  ssSetChecksum1(S,(273527032U));
  ssSetChecksum2(S,(1735598483U));
  ssSetChecksum3(S,(2595349613U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_balancingOptTauQpExtWrenches(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_balancingOptTauQpExtWrenches(SimStruct *S)
{
  SFc2_balancingOptTauQpExtWrenchesInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_balancingOptTauQpExtWrenchesInstanceStruct *)utMalloc
    (sizeof(SFc2_balancingOptTauQpExtWrenchesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_balancingOptTauQpExtWrenches;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_balancingOptTauQpExtWrenches;
...
void c2_balancingOptTauQpExtWrenches_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_balancingOptTauQpExtWrenches(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_balancingOptTauQpExtWrenches(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_balancingOptTauQpExtWrenches(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_balancingOptTauQpExtWrenches_method_dispatcher.\n"
