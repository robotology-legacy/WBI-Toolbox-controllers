#ifndef __c5_torqueBalancing_h__
#define __c5_torqueBalancing_h__
...
#ifndef typedef_SFc5_torqueBalancingInstanceStruct
#define typedef_SFc5_torqueBalancingInstanceStruct
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_torqueBalancing;
  c5_struct_IJeSM2PPiABtzGLybE5MPF c5_reg;
  c5_struct_IHUdSPrvFcumP3hkkkz03F c5_gain;
} SFc5_torqueBalancingInstanceStruct;

#endif                                 /*typedef_SFc5_torqueBalancingInstanceStruct*/
...
extern const mxArray *sf_c5_torqueBalancing_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c5_torqueBalancing_get_check_sum(mxArray *plhs[]);
extern void c5_torqueBalancing_method_dispatcher(SimStruct *S, int_T method,
  void *data);
