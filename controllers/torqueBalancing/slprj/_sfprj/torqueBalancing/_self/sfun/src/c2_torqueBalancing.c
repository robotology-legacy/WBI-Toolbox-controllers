...
static void initialize_c2_torqueBalancing(SFc2_torqueBalancingInstanceStruct
  *chartInstance);
static void initialize_params_c2_torqueBalancing
  (SFc2_torqueBalancingInstanceStruct *chartInstance);
static void enable_c2_torqueBalancing(SFc2_torqueBalancingInstanceStruct
  *chartInstance);
static void disable_c2_torqueBalancing(SFc2_torqueBalancingInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_torqueBalancing
  (SFc2_torqueBalancingInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_torqueBalancing
  (SFc2_torqueBalancingInstanceStruct *chartInstance);
static void set_sim_state_c2_torqueBalancing(SFc2_torqueBalancingInstanceStruct *
  chartInstance, const mxArray *c2_st);
static void finalize_c2_torqueBalancing(SFc2_torqueBalancingInstanceStruct
  *chartInstance);
static void sf_gateway_c2_torqueBalancing(SFc2_torqueBalancingInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_torqueBalancing(SFc2_torqueBalancingInstanceStruct
  *chartInstance);
static void initSimStructsc2_torqueBalancing(SFc2_torqueBalancingInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_torqueBalancingInstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier, real_T
  c2_b_y[6]);
static void c2_b_emlrt_marshallIn(SFc2_torqueBalancingInstanceStruct
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_torqueBalancingInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_d_emlrt_marshallIn(SFc2_torqueBalancingInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
...
static real_T c2_sum(SFc2_torqueBalancingInstanceStruct *chartInstance, real_T
                     c2_x[2]);
static void c2_pinv(SFc2_torqueBalancingInstanceStruct *chartInstance, real_T
                    c2_A_data[], int32_T c2_A_sizes[2], real_T c2_X_data[],
                    int32_T c2_X_sizes[2]);
static void c2_eml_switch_helper(SFc2_torqueBalancingInstanceStruct
  *chartInstance);
static void c2_check_forloop_overflow_error(SFc2_torqueBalancingInstanceStruct
  *chartInstance, boolean_T c2_overflow);
static boolean_T c2_isfinite(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_x);
static void c2_eml_error(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_eml_scalar_eg(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_threshold(SFc2_torqueBalancingInstanceStruct *chartInstance);
static real_T c2_abs(SFc2_torqueBalancingInstanceStruct *chartInstance, real_T
                     c2_x);
static void c2_realmin(SFc2_torqueBalancingInstanceStruct *chartInstance);
static real_T c2_eml_div(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_x, real_T c2_y);
static void c2_b_threshold(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_c_threshold(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_d_threshold(SFc2_torqueBalancingInstanceStruct *chartInstance);
static real_T c2_eml_xdotc(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T c2_ix0,
  real_T c2_y_data[], int32_T c2_y_sizes[2], int32_T c2_iy0);
static void c2_scalarEg(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
...
static void c2_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T c2_ix0, real_T
  c2_b_x_data[], int32_T c2_b_x_sizes[2]);
static void c2_b_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T
  c2_ix0, real_T c2_b_x_data[], int32_T c2_b_x_sizes[2]);
static void c2_eps(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_b_eml_error(SFc2_torqueBalancingInstanceStruct *chartInstance);
static real_T c2_sqrt(SFc2_torqueBalancingInstanceStruct *chartInstance, real_T
                      c2_x);
static void c2_c_eml_error(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_eml_xrotg(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_a, real_T c2_b, real_T *c2_b_a, real_T *c2_b_b, real_T *c2_c, real_T
  *c2_s);
static void c2_eml_xrot(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T c2_ix0,
  int32_T c2_iy0, real_T c2_c, real_T c2_s, real_T c2_b_x_data[], int32_T
  c2_b_x_sizes[2]);
static void c2_e_threshold(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_eml_xswap(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T c2_ix0,
  int32_T c2_iy0, real_T c2_b_x_data[], int32_T c2_b_x_sizes[2]);
static void c2_f_threshold(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_d_eml_scalar_eg(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_eml_xgesvd(SFc2_torqueBalancingInstanceStruct *chartInstance,
...
static real_T c2_eml_xnrm2(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T c2_ix0);
static void c2_c_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T
  c2_ix0, real_T c2_b_x_data[], int32_T c2_b_x_sizes[2]);
static real_T c2_b_eml_xdotc(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T c2_ix0,
  real_T c2_y_data[], int32_T c2_y_sizes[2], int32_T c2_iy0);
static void c2_b_scalarEg(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_b_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y_data[], int32_T
  c2_y_sizes[2], int32_T c2_iy0, real_T c2_b_y_data[], int32_T c2_b_y_sizes[2]);
static real_T c2_b_eml_xnrm2(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[6], int32_T c2_ix0);
static void c2_d_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x[6], int32_T c2_ix0, real_T c2_b_x[6]);
static void c2_c_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T
  c2_ix0, real_T c2_y_data[], int32_T c2_y_sizes, int32_T c2_iy0, real_T
  c2_b_y_data[], int32_T *c2_b_y_sizes);
static void c2_d_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
...
static real_T c2_c_eml_xdotc(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[36], int32_T c2_ix0, real_T c2_y[36], int32_T c2_iy0);
static void c2_e_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y[36], int32_T c2_iy0,
  real_T c2_b_y[36]);
static void c2_e_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_a, real_T c2_x[36], int32_T c2_ix0, real_T c2_b_x[36]);
static void c2_b_eml_xrot(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_x[36], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c, real_T c2_s,
  real_T c2_b_x[36]);
static void c2_e_eml_scalar_eg(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_b_eml_xswap(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_x[36], int32_T c2_ix0, int32_T c2_iy0, real_T c2_b_x[36]);
static void c2_g_threshold(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_eml_xgemm(SFc2_torqueBalancingInstanceStruct *chartInstance,
...
static void c2_f_eml_scalar_eg(SFc2_torqueBalancingInstanceStruct *chartInstance);
static void c2_b_eml_xgemm(SFc2_torqueBalancingInstanceStruct *chartInstance,
...
static void c2_g_eml_scalar_eg(SFc2_torqueBalancingInstanceStruct *chartInstance);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_torqueBalancingInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_torqueBalancingInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_torqueBalancing, const char_T
  *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_torqueBalancingInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_f_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y_data[], int32_T
  c2_y_sizes[2], int32_T c2_iy0);
static void c2_f_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T c2_ix0);
static void c2_g_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T
  c2_ix0);
static void c2_b_sqrt(SFc2_torqueBalancingInstanceStruct *chartInstance, real_T *
                      c2_x);
static void c2_b_eml_xrotg(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T *c2_a, real_T *c2_b, real_T *c2_c, real_T *c2_s);
static void c2_c_eml_xrot(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T c2_ix0,
  int32_T c2_iy0, real_T c2_c, real_T c2_s);
static void c2_c_eml_xswap(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T c2_ix0,
  int32_T c2_iy0);
static void c2_h_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T
  c2_ix0);
static void c2_g_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y_data[], int32_T
  c2_y_sizes[2], int32_T c2_iy0);
static void c2_i_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x[6], int32_T c2_ix0);
static void c2_h_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes[2], int32_T
  c2_ix0, real_T c2_y_data[], int32_T *c2_y_sizes, int32_T c2_iy0);
static void c2_i_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, real_T c2_x_data[], int32_T c2_x_sizes, int32_T
  c2_ix0, real_T c2_y_data[], int32_T c2_y_sizes[2], int32_T c2_iy0);
static void c2_j_eml_xaxpy(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_a, int32_T c2_ix0, real_T c2_y[36], int32_T c2_iy0);
static void c2_j_eml_xscal(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_a, real_T c2_x[36], int32_T c2_ix0);
static void c2_d_eml_xrot(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_x[36], int32_T c2_ix0, int32_T c2_iy0, real_T c2_c, real_T c2_s);
static void c2_d_eml_xswap(SFc2_torqueBalancingInstanceStruct *chartInstance,
  real_T c2_x[36], int32_T c2_ix0, int32_T c2_iy0);
static void c2_c_eml_xgemm(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_n, int32_T c2_k, real_T c2_A_data[], int32_T c2_A_sizes[2], real_T
  c2_B_data[], int32_T c2_B_sizes[2], int32_T c2_ldb, real_T c2_C_data[],
  int32_T c2_C_sizes[2]);
static void c2_d_eml_xgemm(SFc2_torqueBalancingInstanceStruct *chartInstance,
  int32_T c2_k, real_T c2_A_data[], int32_T c2_A_sizes[2], real_T c2_B_data[],
  int32_T c2_B_sizes[2], int32_T c2_ldb, real_T c2_C[138]);
static void init_dsm_address_info(SFc2_torqueBalancingInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_torqueBalancing = 0U;
}
  ...
  (SFc2_torqueBalancingInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_torqueBalancing;
  ...
  chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_torqueBalancing = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_torqueBalancing");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_torqueBalancing(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_torqueBalancing(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_torqueBalancingInstanceStruct *chartInstance;
  chartInstance = (SFc2_torqueBalancingInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_torqueBalancing_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_torqueBalancing), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_torqueBalancing);
  return c2_y;
}
...
void sf_c2_torqueBalancing_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_torqueBalancing_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_torqueBalancing_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_torqueBalancing_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_torqueBalancing(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_torqueBalancing\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_torqueBalancing_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_torqueBalancingInstanceStruct *)
...
static void sf_opaque_initialize_c2_torqueBalancing(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_torqueBalancingInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_torqueBalancing((SFc2_torqueBalancingInstanceStruct*)
    chartInstanceVar);
  initialize_c2_torqueBalancing((SFc2_torqueBalancingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_torqueBalancing(void *chartInstanceVar)
{
  enable_c2_torqueBalancing((SFc2_torqueBalancingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_torqueBalancing(void *chartInstanceVar)
{
  disable_c2_torqueBalancing((SFc2_torqueBalancingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_torqueBalancing(void *chartInstanceVar)
{
  sf_gateway_c2_torqueBalancing((SFc2_torqueBalancingInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_torqueBalancing(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_torqueBalancing
    ((SFc2_torqueBalancingInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_torqueBalancing();/* state var info */
...
extern void sf_internal_set_sim_state_c2_torqueBalancing(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_torqueBalancing();/* state var info */
  ...
  set_sim_state_c2_torqueBalancing((SFc2_torqueBalancingInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_torqueBalancing(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_torqueBalancing(S);
}

static void sf_opaque_set_sim_state_c2_torqueBalancing(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_torqueBalancing(S, st);
}

static void sf_opaque_terminate_c2_torqueBalancing(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_torqueBalancingInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_torqueBalancing((SFc2_torqueBalancingInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_torqueBalancing((SFc2_torqueBalancingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_torqueBalancing(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_torqueBalancing(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_torqueBalancing(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_torqueBalancing(SimStruct *S)
{
  SFc2_torqueBalancingInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_torqueBalancingInstanceStruct *)utMalloc(sizeof
    (SFc2_torqueBalancingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_torqueBalancingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_torqueBalancing;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_torqueBalancing;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_torqueBalancing;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_torqueBalancing;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_torqueBalancing;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_torqueBalancing;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_torqueBalancing;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_torqueBalancing;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_torqueBalancing;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_torqueBalancing;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_torqueBalancing;
...
void c2_torqueBalancing_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_torqueBalancing(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_torqueBalancing(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_torqueBalancing(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_torqueBalancing_method_dispatcher.\n"
