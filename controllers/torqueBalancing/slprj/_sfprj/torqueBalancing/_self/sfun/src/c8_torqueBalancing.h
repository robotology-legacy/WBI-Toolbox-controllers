#ifndef __c8_torqueBalancing_h__
#define __c8_torqueBalancing_h__
...
#ifndef typedef_SFc8_torqueBalancingInstanceStruct
#define typedef_SFc8_torqueBalancingInstanceStruct
...
typedef struct {
  ...
  uint8_T c8_is_active_c8_torqueBalancing;
  c8_struct_IHUdSPrvFcumP3hkkkz03F c8_gain;
} SFc8_torqueBalancingInstanceStruct;

#endif                                 /*typedef_SFc8_torqueBalancingInstanceStruct*/
...
extern const mxArray *sf_c8_torqueBalancing_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c8_torqueBalancing_get_check_sum(mxArray *plhs[]);
extern void c8_torqueBalancing_method_dispatcher(SimStruct *S, int_T method,
  void *data);
