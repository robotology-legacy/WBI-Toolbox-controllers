...
###Compatibility
The Simulink models are  compatible with Matlab R2012b and R2015b. Also, the controller is tested in simulation by using Gazebo 7.0. Older versions of Gazebo may lead to scarse, or unstable, control performances.
