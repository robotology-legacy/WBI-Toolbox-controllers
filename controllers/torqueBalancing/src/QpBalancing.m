...
block.InputPort(4).Dimensions        = [30  8];   % ConstraintsMatrixQP2Feet 
block.InputPort(5).Dimensions        = [ 1 30];   % bVectorConstraintsQp2Feet 
...
block.InputPort(9).Dimensions        = [15  4];   % ConstraintsMatrixQP1Foot
block.InputPort(10).Dimensions       = [ 1 15];   % bVectorConstraintsQp1Foot
