...
if USE_SM
    ...
    gain.impedances  = [10   10   20, 10   10    10    8, 10   10    10    8, 30   30   20    20     10  10, 30   50   30    60      5   5  % state == 1  TWO FEET BALANCING
                        ...
                        30   30   30, 10   10    10   10, 10   10    10   10,100   90   20    20     10  10,100   50   30   100     25  25  % state == 4  YOGA LEFT FOOT 
                        30   30   30, 20   20    20    8, 20   20    20   12,200  250   20    20     10  10,220  550  220   200     65 300  % state == 5  PREPARING FOR SWITCHING 
                        30   30   30, 20   20    20    8, 20   20    20   12,100  350   20   200     10 100,220  550  220   200     65 300  % state == 6  LOOKING FOR CONTACT
                        30   30   30, 20   20    20    8, 20   20    20    8, 30   30   20    20     10  10, 30   30   20    20     10  10];% state == 7  BALANCING TWO FEET 
...
sm.joints.states = [[0.0864,0.0258,0.0152, ...                          %% state == 1  TWO FEET BALANCING
                    ...
                    [0.0864,0.0258,0.0152, ...                          %% state == 2  COM TRANSITION TO LEFT 
                     0.1253,0.8135,0.3051,0.7928 ...                    %
                     0.0563,0.6789,0.3340,0.6214 ...                    %
                     zeros(1,6), ...                                    %  
                     zeros(1,6)];                                       %  
                    ...
                    [0.0864,0.0258,0.0152, ...                          %% state == 4  YOGA LEFT FOOT, THIS REFERENCE IS IGNORED 
                     ...
                     0.0522,-0.2582,0.0014,-0.2129,-0.0944,0.1937,...   %
                     0.0128,0.4367,0.0093,-0.1585,-0.0725,-0.2931];     %
                    [0.0864,0.0258,0.0152, ...                          %  state == 5  PREPARING FOR SWITCHING 
                     0.1253,0.8135,0.3051,0.7928 ...                    %
                     0.0563,0.6789,0.3340,0.6214 ...                    %
                    ...
                    [0.0864,0.0258,0.0152, ...                          %% state == 6  LOOKING FOR CONTACT
                     ...
                     0.0107,-0.0741,-0.0001,-0.0120,0.0252,0.1369,...   %
                     -0.0026,0.0225,0.0093,-0.0020,0.0027,-0.0277];     %   
                    [0.0864,0.0258,0.0152, ...                          %% state == 7  BALANCING TWO FEET
                     0.1253,0.8135,0.3051,0.7928 ...                    %
                     0.0563,0.6789,0.3340,0.6214 ...                    %
                     0.0522,-0.2582,0.0014,-0.2129,-0.0944,0.1937,...   %
                     0.0128,0.4367,0.0093,-0.1585,-0.0725,-0.2931]];    %
