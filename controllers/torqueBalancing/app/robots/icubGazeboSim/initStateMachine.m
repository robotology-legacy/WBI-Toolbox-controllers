...
if strcmpi(SM.SM_TYPE, 'YOGA')
    ...
    gain.impedances  = [10   30   20, 10   10    10    8, 10   10    10    8, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  1  TWO FEET BALANCING
                        ...
                        30   30   30, 10   10    10   10, 10   10    10   10,100  100  150   200    100  50,100   50   30   100     50  50  % state ==  4  YOGA LEFT FOOT 
                        30   30   30, 10   10    10   10, 10   10    10   10, 30   50   30    60     50  50, 30   50   30    60     50  50  % state ==  5  PREPARING FOR SWITCHING 
                        ...
                        30   30   30, 10   10    10   10, 10   10    10   10,100   50   30   100     50  50,100  100  150   200    100  50  % state == 10  YOGA RIGHT FOOT 
