...
if CONFIG.USE_SM
    ...
    %                  %%         LEFT LEG            %%         RIGHT LEG              %% 
    gain.impedances  = [30   30   20    20     10  10, 30   50   30    60      5   5    % state ==  1  WATING FOR REFERENCES
                        30   30   20    20     10  10, 30   50   30    60      5   5    % state ==  2  TWO FEET BALANCING
                        30   30   20    20     10  10, 30   50   30    60      5   5    % state ==  3  LEFT FOOT BALANCING
                        30   50   30    60      5   5, 30   30   20    20     10  10];  % state ==  4  RIGHT FOOT BALANCING
