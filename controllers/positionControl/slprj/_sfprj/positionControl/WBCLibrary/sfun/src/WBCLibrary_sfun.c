  ...
  int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==1) {
    c1_WBCLibrary_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"WBCLibrary")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4199505594U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2340068027U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3897183857U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(574800202U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 1:
            {
              extern void sf_c1_WBCLibrary_get_check_sum(mxArray *plhs[]);
              sf_c1_WBCLibrary_get_check_sum(plhs);
              break;
            }
     ...
     case 1:
      {
        if (strcmp(aiChksum, "xkDb8k5eqMP7aXB5oUFLxD") == 0) {
          extern mxArray *sf_c1_WBCLibrary_get_autoinheritance_info(void);
          plhs[0] = sf_c1_WBCLibrary_get_autoinheritance_info();
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        extern const mxArray *sf_c1_WBCLibrary_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c1_WBCLibrary_get_eml_resolved_functions_info();
     ...
     case 1:
      {
        if (strcmp(tpChksum, "CbqhCBbjbXK2C4fod3g2mC") == 0) {
          extern mxArray *sf_c1_WBCLibrary_third_party_uses_info(void);
          plhs[0] = sf_c1_WBCLibrary_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "CbqhCBbjbXK2C4fod3g2mC") == 0) {
          extern mxArray *sf_c1_WBCLibrary_updateBuildInfo_args_info(void);
          plhs[0] = sf_c1_WBCLibrary_updateBuildInfo_args_info();
          break;
        }
      }
